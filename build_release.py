...
wrap_dir = "convert_mapping_node"  # Wrap the output in a directory in the ZIP file
output_file = f"convert_mapping_node_{tag_name}.zip"  # What to call the ZIP file
